...
const values = coding.forEach( (item) => {  //forEach did not return any value 
    //console.log(item);
    return item
} )
...
// It returns a new array of the same length as the original array, where each element is the result of applying the provided function to the corresponding element of the original array.
